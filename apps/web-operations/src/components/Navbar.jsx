  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="mx-4 w-full max-w-sm overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div className="p-6">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-[#EBF4FF]">
            <LogOut size={22} className="text-[#052659]" />
          </div>

          <h2 className="mb-1 text-lg font-bold text-[#021024]">
            Sign out?
          </h2>
...
function Navbar({
  ...
  const confirmLogout = () => {
    ...
    // Fallback only when the parent authentication flow does not provide onLogout.
    localStorage.clear();
  ...
  return (
    <>
      ...
      >
        {/* Left — menu button + compact logo when sidebar is collapsed */}
        ...
        {/* Center — search */}
        <div
          className="hidden w-72 items-center gap-2.5 rounded-xl px-4 py-2 md:flex"
        ...
        <div className="flex items-center gap-1">
          ...
          >
            ...
            <span
              className="absolute right-[9px] top-[9px] h-2 w-2 rounded-full ring-[1.5px] ring-white"
